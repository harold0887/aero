                        ...
                        @csrf @method('PATCH')
                            ...
                            <div class="form-row   mt-lg-5">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="ckeditor form-control {{ $errors->has('information') ? ' is-invalid border-danger' : '' }}" name="information" rows="5" 
                                    value="">{{ old('information') ?: $plantilla->message }}</textarea>
                                    @error('information')
                                    <small class="text-danger"> {{ $message }} </small>
                                    @enderror
                                </div>
